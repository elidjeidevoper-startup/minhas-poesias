    ...
    <main className="flex flex-col items-center justify-center min-h-screen p-8">
      <div className="w-full max-w-md flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-2 text-center mt-4">
          <h1 className="text-3xl font-serif text-ink tracking-tight">Entrar</h1>
          <p className="text-ink-light">Acesse suas poesias salvas</p>
        </div>
        ...
        <form action={login} className="flex flex-col gap-4 mt-4">
          ...
          <div className="flex flex-col gap-1">
            <label htmlFor="password" className="text-sm text-ink-light">Senha</label>
            <input 
              type="password" 
              id="password" 
              name="password" 
        ...
        <p className="text-center text-sm text-ink-light mt-4">
          Ainda não tem uma conta? <Link href="/cadastro" className="text-ink underline hover:text-ink-light">Começar</Link>
        </p>
      </div>
    </main>
  );
